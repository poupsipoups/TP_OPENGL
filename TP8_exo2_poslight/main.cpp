...
int main()
{
    ...
    ctx.update = [&]() {
        ...
        glm::vec4 tViewXPoint = viewCamera * glm::vec4(glm::vec3(0.f, 4.f, 0.f), 0.f);
        glm::vec3 tLightPoint = glm::vec3(tViewXPoint.x, tViewXPoint.y, tViewXPoint.z);
        glUniform3fv(earthProgram.uLightPos, 1, glm::value_ptr(tLightPoint));
        //  glUniform3fv(earthProgram.uDirLight, 1, glm::value_ptr(glm::rotate(viewCamera, ctx.time(), glm::vec3(1.f)) * glm::vec4(1, 1, 0, 1)));

        glUniform3fv(earthProgram.uLightIntensity, 1, glm::value_ptr(glm::vec3(10.f)));
        ...
        for (int i = 0; i < 32; i++)
        {
            ...
            // glm::vec4 tViewXPoint = viewCamera * glm::vec4(glm::vec3(1.f), 0.f);
            // glm::vec3 tLightPoint = glm::vec3(tViewXPoint.x, tViewXPoint.y, tViewXPoint.z);
            // glUniform3fv(moonProgram.uLightPos, 1, glm::value_ptr(tLightPoint));
