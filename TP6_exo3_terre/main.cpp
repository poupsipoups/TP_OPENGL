...
int main()
{
    ...
    img::Image terre_map = p6::load_image_buffer("/home/pauline/Documents/S4/openGL/TP_OPENGL/bin/TP6_exo3_terre/assets/textures/EarthMap.jpg");

    img::Image lune_map = p6::load_image_buffer("/home/pauline/Documents/S4/openGL/TP_OPENGL/bin/TP6_exo3_terre/assets/textures/MoonMap.jpg");

    // On charge les shaders
    const p6::Shader shader = p6::load_shader("shaders/3D.vs.glsl", "shaders/tex3D.fs.glsl");
